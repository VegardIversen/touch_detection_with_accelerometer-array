...
from main_scripts.project_thesis import (
    setup1_results,
    setup2_results,
    setup3_results,
    custom_plots,
...
from main_scripts.dispersion_compensation import correct_dispersion, dispersive_filter
...
def main():
    ...
    while input not in ["0", "1", "2", "3"]:
        ...
        if user_input == "1":
            ...
            print(
                "Please type 1, 2 or 3 for their respective setups "
