...
def generate_chirp_and_save_to_file(sample_rate=150000,
                                    frequency_start=20000,
                                    frequency_stop=40000,
                                    time_end=0.125,
                                    chirp_method='linear',
                                    save_to_file=True):
    print(f"Fs: {sample_rate}, freq_start: {frequency_start}, freq_stop: {frequency_stop}, t_max: {time_end}")
    print(f"Time-bandwidth product: {time_end * sample_rate}")
