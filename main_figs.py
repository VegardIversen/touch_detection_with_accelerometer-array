...
if __name__ == '__main__':
    ...
    #phase, freq  = wp.phase_plotting(df, chirp=custom_chirp, use_recorded_chirp=True, BANDWIDTH=[100,40000], start_stops=[(146000,441200),(146000,442000)])
    #phase1, freq1  = wp.phase_plotting(df1, chirp=custom_chirp, use_recorded_chirp=True, start_stops=[(95000,390500),(94000,390400)], BANDWIDTH=[100,40000])
    #phase_vel = wp.phase_velocity(phase, freq, distance=0.15, plot=True)
    #wp.plot_velocities(phase, freq, 0.15, savefig=True, filename='phase_velocity_15cm.svg', file_format='svg')
